...
In \cite{Jones2013}, Jones shows how to perform an Toffoli with a T-cost of 4 even when not pairs.
They do so by involving an ancilla qubit and an erasure technique that turns what would have been a quantum control into a classical control.
